...
/-- Integer addition modulo 2^128, transported by an explicit word representation. -/
def integerTwist {F : Type*} (word : F ≃ ZMod (2 ^ 128)) (τ v : F) : F :=
  word.symm (word v + word τ)

theorem integerTwist_bijective {F : Type*} (word : F ≃ ZMod (2 ^ 128)) (τ : F) :
