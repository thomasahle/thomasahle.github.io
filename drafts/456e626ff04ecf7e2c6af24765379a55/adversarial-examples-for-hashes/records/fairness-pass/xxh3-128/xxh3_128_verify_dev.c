/* Port of verify/xxh3-128/xxh3_128_verify.c driver to the upstream dev header (XXH 0.8.4-dev). */
...
static const Variant variants[] = { {"XXH3-128 dev(0.8.4)",hash_0,128,64,1,0x288DAA94} };
