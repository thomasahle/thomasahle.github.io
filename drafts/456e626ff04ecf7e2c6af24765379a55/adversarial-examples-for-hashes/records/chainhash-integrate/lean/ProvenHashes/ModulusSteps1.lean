...
theorem residue_step_9 : residue_9 ^ 2 = residue_10 + modulus * (sparse [0]) := by
...
theorem residue_step_10 : residue_10 ^ 2 = residue_11 + modulus * (sparse [32]) := by
...
theorem residue_step_11 : residue_11 ^ 2 = residue_12 + modulus * (sparse [2, 6, 8]) := by
...
theorem residue_step_12 : residue_12 ^ 2 = residue_13 + modulus * (sparse []) := by
...
theorem residue_step_13 : residue_13 ^ 2 = residue_14 + modulus * (sparse [0]) := by
...
theorem residue_step_14 : residue_14 ^ 2 = residue_15 + modulus * (sparse [0, 16, 24]) := by
...
theorem residue_step_15 : residue_15 ^ 2 = residue_16 + modulus * (sparse [0, 16, 48]) := by
