...
#include "../../../verify/rapidhash-v3/rapidhash_v3_verify.c"
#undef main
#undef validate
#undef hash_pair
#undef rng_init
...
static const DemoPair demo_pairs[] = {
    {{demo_message_0,demo_message_1},{32,32},64,64,1,0,0,{UINT64_C(0x3187ae8a8617e034)},"a7ee6375a78a86f0"},
    {{demo_message_0,demo_message_1},{32,32},64,64,1,1,0,{UINT64_C(0x3187ae8a8617e034)},NULL},
    {{demo_message_0,demo_message_1},{32,32},64,64,1,2,0,{UINT64_C(0x3187ae8a8617e034)},NULL},
};
