...
#include "../../../verify/nmhash32x/nmhash32x_verify.c"
#undef main
#undef validate
#undef hash_pair
#undef rng_init
...
0x08,0x80,0x00,0x08,0x08,0x80,0x00,0x08,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x08,0x80,0x80,0x00,0x08,0x80
};
static const DemoPair demo_pairs[] = {
    {{demo_message_0,demo_message_1},{28,28},32,32,1,0,0,{UINT64_C(0x0000000000000000)},"dc5952ce"},
};
