...
nice -n 10 taskset -c 40-47 lake build
nice -n 10 taskset -c 40-47 lake env lean Audit.lean > Audit.txt
nice -n 10 taskset -c 40-47 lake env lean FullAudit.lean > FullAudit.txt
python3 - <<'PY'
